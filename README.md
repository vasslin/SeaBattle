...
Ветка _remake_ содержит улучшенную версию работы (с исправлением багов, изменением структуры проекта(при необходимости)), созданную по окончании 1 курса и завершении курса Программирование на C++.
